...
const FindCompaniesWhatsappService_1 = __importDefault(require("../CompanyService/FindCompaniesWhatsappService"));
...
const BlockUnblockContactService = async ({ contactId, companyId, active }) => {
    ...
    if (active) {
        try {
            const whatsappCompany = await (0, FindCompaniesWhatsappService_1.default)(companyId);
