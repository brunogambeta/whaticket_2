...
const ListTicketsService = async ({ searchParam = "", pageNumber = "1", queueIds, tags, users, status, date, dateStart, dateEnd, updatedAt, showAll, userId, withUnreadMessages, contacts, updatedStart, updatedEnd, connections, statusFilter, queuesFilter, isGroup, companyId }) => {
    let whereCondition = {
    ...
    includeCondition = [
        {
            ...
            as: "contact",
            attributes: ["id", "name", "number", "email", "profilePicUrl", "acceptAudioMessage", "active"]
        },
        {
