...
exports.restart = exports.remove = exports.update = exports.show = exports.storeFacebook = exports.store = exports.index = void 0;
...
const store = async (req, res) => {
    const { name, status, isDefault, greetingMessage, complationMessage, outOfHoursMessage, queueIds, token, maxUseBotQueues, expiresTicket } = req.body;
    const { companyId } = req.user;
