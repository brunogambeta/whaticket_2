...
exports.remove = exports.update = exports.showFromUUID = exports.show = exports.store = exports.kanban = exports.index = void 0;
...
const index = async (req, res) => {
    const { pageNumber, status, date, dateStart, dateEnd, updatedAt, searchParam, showAll, queueIds: queueIdsStringified, tags: tagIdsStringified, users: userIdsStringified, withUnreadMessages, 
    // contacts,
    // updatedStart,
    // updatedEnd,
    // connections,
